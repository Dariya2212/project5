...
OperationAmount = Dict[str, Union[str, Currency]]
Transaction = Dict[str, Union[int, str, OperationAmount]]
...
@pytest.fixture
def transactions_empty_description() -> List[Transaction]:
    return [
        {
            "id": 939719570,
            "state": "EXECUTED",
...
@pytest.fixture
def dif_transactions() -> List[Transaction]:
    return [
        {
            "id": 939719570,
            "state": "EXECUTED",
